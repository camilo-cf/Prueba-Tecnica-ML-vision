...
cv2.imwrite('Objeto3.jpg', cropped);
...
clustering = Birch(threshold=min(image_template.shape[:2])*0.5 , n_clusters=None).fit(lista)
...
cv2.imwrite('SIFT_DETECTION_2.jpg', input_image);
