...
x_detect, y_detect, score, counter = explore_image_inceptionv3(resized_image, cropped, 0.75)


## Clusterización
input_image, centroids = clustering(x_detect, y_detect, cropped, resized_image, 0.4)
